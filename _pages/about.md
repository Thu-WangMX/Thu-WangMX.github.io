...
<div style="display: flex; align-items: flex-start; gap: 12px;"><img src="stamp.png" alt="STAMP" style="width: 80px; height: 80px; object-fit: cover; flex-shrink: 0;"><div><b>STAMP: Spatio-Temporal Augmented Memory Policy for Robotic Manipulation</b><br>Zhirun Yue, <b>Mingxin Wang</b><br><i>Submitted to IJCNN 2026</i><br>Introduces a spatio-temporal augmented memory policy with a hierarchical memory pyramid for robust robotic manipulation in complex scenarios.</div></div>
---
